...
import { Pencil, Wrench, BuildingApartment, GraduationCap, Moon, Sun, Image, ArrowClockwise, House, Archive, PlusCircle, ArrowsLeftRight, SignOut, GearSix, MagnifyingGlass, Eye, Plus, ArrowRight, MicrosoftExcelLogo } from '@phosphor-icons/react'
export const IconHome = House
export const IconPlusCircle = PlusCircle
export const IconArchive = Archive
export const IconLogout = SignOut
...
export const IconZoom = MagnifyingGlass
export const IconReload = ArrowClockwise
export const IconMove = ArrowsLeftRight
...
export const IconExcel= MicrosoftExcelLogo
